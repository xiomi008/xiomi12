...
cl = LINETCR.LINE()
cl.login(token="En9YuxSu8PJs6PmOctV1.FaarasuAWykZHuW+vxFquq.u3D/mNVWCThQIpws2XbL5h0sz0GD3Olap/URoD9pPE0=")
cl.loginResult()
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["ᴅᴏɴᴛ ᴛᴀɢ ᴍᴇ!! ɪᴍ ʙᴜsʏ",cName + " ɴɢᴀᴘᴀɪɴ ɴɢᴇᴛᴀɢ?",cName + " ɴɢɢᴀᴋ ᴜsᴀʜ ᴛᴀɢ-ᴛᴀɢ! ᴋᴀʟᴏ ᴘᴇɴᴛɪɴɢ ʟᴀɴɢsᴜɴɢ ᴘᴄ ᴀᴊᴀ","-_-","Sarii sᴇᴅᴀɴɢ ᴏғғ", cName + " ᴋᴇɴᴀᴘᴀ ᴛᴀɢ sᴀʏᴀ?","sᴘᴀᴍ ᴘᴄ ᴀᴊᴀ " + cName, "ᴊᴀɴɢᴀɴ sᴜᴋᴀ ᴛᴀɢ ɢᴜᴀ " + cName, "ᴋᴀᴍᴜ sɪᴀᴘᴀ ? " + cName + "?", "ᴀᴅᴀ ᴘᴇʀʟᴜ ᴀᴘᴀ ? " + cName + "?","ᴀᴅᴀ ᴀᴘᴀ sᴀʏᴀɴɢ","Tersummon -_-"]
...
#==============================================#
        ...
        if op.type == 17:
          ...
          random.choice(KAC).sendText(op.param1, "Selamat Datang Di Grup Budayakan Baca Note !!! yah Ka 😊Semoga Betah Kk 😘 n jgan Lupa pkee tagg.a yahh '[E✘D]' Semoga Betah digrup " + str(ginfo.name))
          print "MEMBER HAS JOIN THE GROUP"
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "Oke ")
